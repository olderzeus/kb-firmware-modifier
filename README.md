...
7. **TrackPoint Settings**  
   Set the trackpoint speed settings. You can fully control the relashionships between trackpoint tilt amount and cursor speed. You can also use easy preset settings.
