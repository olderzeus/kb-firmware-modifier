...
const PRESET_1: [[i8; 43]; 9] = [
        ...
        [
             0,  1,  5,  7,  9, 12, 14, 16, 18, 21, 23, 25, 27, 29, 32, 34, 36, 38, 41, 43, 45,
            47, 50, 52, 54, 56, 58, 61, 63, 65, 67, 70, 72, 74, 76, 78, 81, 83, 85, 87, 90, 92,
            94
        ],
    ];
...
const PRESET_2: [[i8; 43]; 9] = [
        ...
        [
             0,  1,  6,  8, 11, 13, 16, 18, 20, 23, 25, 28, 30, 32, 35, 37, 40, 42, 44, 47, 49,
            52, 54, 56, 59, 61, 64, 66, 68, 71, 73, 76, 78, 80, 83, 85, 88, 90, 92, 95, 97, 100,
            102
        ],
    ];
...
const PRESET_3: [[i8; 43]; 9] = [
        ...
        [
             0,  1,  7, 10, 12, 15, 17, 20, 22, 25, 28, 30, 33, 35, 38, 40, 43, 46, 48, 51, 53, 56,
            59, 61, 64, 66, 69, 71, 74, 77, 79, 82, 84, 87, 89, 92, 95, 97, 100, 102, 105, 107, 110
        ],
    ];
...
const PRESET_4: [[i8; 43]; 9] = [
        ...
        [
             0,  1,  5,  7,  9, 12, 14, 16, 18, 21, 23, 25, 27, 29, 32, 34, 36, 38, 41, 43, 45,
            47, 50, 52, 54, 56, 58, 61, 63, 65, 67, 70, 72, 74, 76, 78, 81, 83, 85, 87, 90, 92, 94
        ],
        [
             0,  1,  6,  8, 11, 13, 16, 18, 20, 23, 25, 28, 30, 32, 35, 37, 40, 42, 44, 47, 49,
            52, 54, 56, 59, 61, 64, 66, 68, 71, 73, 76, 78, 80, 83, 85, 88, 90, 92, 95, 97, 100, 102
        ],
        [
             0,  1,  7, 10, 12, 15, 17, 20, 22, 25, 28, 30, 33, 35, 38, 40, 43, 46, 48, 51, 53, 56,
            59, 61, 64, 66, 69, 71, 74, 77, 79, 82, 84, 87, 89, 92, 95, 97, 100, 102, 105, 107, 110
        ...
        [
            0,   1,  8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50, 53, 56, 59, 62, 65,
            68, 70, 73, 76, 79, 82, 85, 88, 91, 94, 97, 100, 103, 106, 109, 112, 115, 118, 121, 124, 127
        ],
    ];
